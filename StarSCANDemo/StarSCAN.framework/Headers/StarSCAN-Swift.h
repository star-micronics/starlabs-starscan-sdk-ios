...
#ifndef STARSCAN_SWIFT_H
#define STARSCAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StarSCAN",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8StarSCAN11DFUFirmware")
...
SWIFT_CLASS("_TtC8StarSCAN15DFUFirmwareSize")
...
SWIFT_PROTOCOL("_TtP8StarSCAN29DFUPeripheralSelectorDelegate_")
...
SWIFT_CLASS("_TtC8StarSCAN21DFUPeripheralSelector")
...
/// Uploading state.
SWIFT_PROTOCOL("_TtP8StarSCAN19DFUProgressDelegate_")
...
SWIFT_CLASS("_TtC8StarSCAN20DFUServiceController")
...
SWIFT_PROTOCOL("_TtP8StarSCAN18DFUServiceDelegate_")
...
SWIFT_CLASS("_TtC8StarSCAN19DFUServiceInitiator")
...
/// DFU UUID object.
SWIFT_CLASS("_TtC8StarSCAN7DFUUuid")
...
/// the Nordic devices.
SWIFT_CLASS("_TtC8StarSCAN13DFUUuidHelper")
...
typedef SWIFT_ENUM(NSInteger, FirmwareUpdateState, open) {
/// 升级中
/// on upgrade
  FirmwareUpdateStateUpdating = 0,
/// 升级成功
/// upgrade successed
  FirmwareUpdateStateSuccess = 1,
/// 升级失败
/// upgrade failed
  FirmwareUpdateStateFail = 2,
};
...
/// be ignored.
SWIFT_CLASS("_TtC8StarSCAN21IntelHex2BinConverter")
...
SWIFT_CLASS("_TtC8StarSCAN25LegacyDFUServiceInitiator")
...
/// The Logger delegate.
SWIFT_PROTOCOL("_TtP8StarSCAN14LoggerDelegate_")
@protocol LoggerDelegate
...
SWIFT_CLASS("_TtC8StarSCAN21NlsBleFirmwareVersion")
@interface NlsBleFirmwareVersion : NSObject
@property (nonatomic, copy) NSString * _Nullable productName;
@property (nonatomic, copy) NSString * _Nullable cpuFirmwareVersion;
@property (nonatomic, copy) NSString * _Nullable btFirmwareVersion;
- (NSString * _Nonnull)toString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8StarSCAN9NlsBleLog")
@interface NlsBleLog : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8StarSCAN25SecureDFUServiceInitiator")
...
@protocol StarSCANCentralDelegate;
@class UIApplication;
@class UIImage;
@class StarSCANPeripheral;

SWIFT_CLASS("_TtC8StarSCAN15StarSCANCentral")
@interface StarSCANCentral : NSObject
/// 设置中央设备代理
/// set centralDelegate for StarSCANCentralDelegate
@property (nonatomic, weak) id <StarSCANCentralDelegate> _Nullable centralDelegate;
/// 单例,可以直接使用 central manager 初始化
/// get Singleton, central manager init
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) StarSCANCentral * _Nonnull instance;)
+ (StarSCANCentral * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
/// 单例,可以直接使用 central manager 初始化
/// get Singleton, central manager init
+ (StarSCANCentral * _Nonnull)getInstance SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// AppDelegate启动时调用,让BLE Central Manager保持在app整个的生命周期并且支持后台模式,比如息屏后继续收发数据
/// StarSCANCentral.instance is called when app didFinishLaunching, the BLE central manager must exists for the lifetime of your app and support background execution mode, e.g. receive data while iphone is sleeping
...
- (UIImage * _Nullable)generateConnectCodeBitmap SWIFT_WARN_UNUSED_RESULT;
/// 生成连接条形码 image size:2220x588
/// generate bar code for connect, image size:2220x588
- (UIImage * _Nullable)generateConnectBarCode128 SWIFT_WARN_UNUSED_RESULT;
...
/// e.g. called when enter the “create connection page”
...
/// e.g. called when exit the “create connection page”
- (void)stopScan;
...
/// \param name 指定的外围设备名称,可以为空,  the connected peripheral name or nil
///
/// \param identifier 指定的外围设备identifier,可以为空, the connected peripheral identifier or nil
///
/// \param name=nil && identifier = nil 两个参数都为空则使用系统设置-蓝牙已连上并且sdk未连接过的设备,
...
///
/// returns:
/// true:找到指定设备开始建立ble连接, found the peripheral and establish ble connection.
/// false:未找到设备或者蓝牙关闭, cannot found peripheral or ios bluetooth unavaiable.
- (BOOL)useSystemConnectedPeripheral:(NSString * _Nullable)name :(NSUUID * _Nullable)identifier SWIFT_WARN_UNUSED_RESULT;
/// 断开一个外围设备连接并清除缓存,不再重连
/// disconnect peripheral and clear cache, no longer reconnect it
/// \param peripheral peripheral 
///
/// \param showAlert(optional) 默认true 显示对话框提示到系统设置手动忽略设备,
/// default true:show alert dialog waring to forget this device on system Setting
///
- (void)clearConnect:(StarSCANPeripheral * _Nonnull)peripheral :(BOOL)showAlert;
/// 清除所有已断开连接的设备,不再重试连接
/// clear all did disconnected peripherals, no longer reconnect them
///
/// returns:
/// peripherals identifier that removed, 返回清除的外围设备id
- (NSArray<NSUUID *> * _Nonnull)clearDisconnectedPeripherals SWIFT_WARN_UNUSED_RESULT;
/// 获取可以重连的设备uuid
/// get reconnect peripherals uuid which will reconnect after disconnected
- (NSArray<NSUUID *> * _Nonnull)getReconnectPeripherals SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<StarSCANPeripheral *> * _Nonnull)getControllablePeripherals SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_PROTOCOL("_TtP8StarSCAN23StarSCANCentralDelegate_")
@protocol StarSCANCentralDelegate <NSObject>
@optional
/// 中央设备iphone/ipad蓝牙状态变更,来源CBCentralManagerDelegate.centralManagerDidUpdateState
/// StarSCAN内部已对蓝牙状态作判断,各接口可以直接使用
/// Central iphone/ipad bluetooth state change, from CBCentralManagerDelegate.centralManagerDidUpdateState
/// StarSCAN has judged the bluetooth state internally, sdk func can be used without check state
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
/// 外围设备连接成功并且可读写数据
/// new peripheral has connected, ready for write/read data
/// same as  StarSCANPeripheralDelegate.onReady
- (void)onPeripheralReady:(StarSCANPeripheral * _Nonnull)peripheral;
/// 外围设备断开连接
/// peripheral did disconnected
/// same as  StarSCANPeripheralDelegate.onDidDisconnect
- (void)onPeripheralDidDisconnect:(StarSCANPeripheral * _Nonnull)peripheral;
/// 可以更新连接码二维码条码图片
...
- (void)onStartConnecting:(CBPeripheral * _Nonnull)peripheral :(BOOL)reconnect;
/// 结束连接中状态,隐藏loading, 连接失败或者成功
/// stop connecting, hide loading, connected or failed
- (void)onStopConnecting:(CBPeripheral * _Nonnull)peripheral;
@end

@protocol StarSCANPeripheralDelegate;

SWIFT_CLASS("_TtC8StarSCAN18StarSCANPeripheral")
@interface StarSCANPeripheral : NSObject
/// 外围设备代理
/// peripheral delegate
@property (nonatomic, weak) id <StarSCANPeripheralDelegate> _Nullable peripheralDelegate;
/// 外围设备id
...
/// 设置设备配置, 执行结果回调StarSCANPeripheralDelegate.onSetDeviceConfigResponse
/// set peripheral config,result callback StarSCANPeripheralDelegate.onSetDeviceConfigResponse
- (void)setDeviceConfig:(NSString * _Nonnull)configFilePath;
/// 升级固件,执行过程中的状态onUpdate()
/// update firmware, sate for update callback onUpdate()
- (void)updateFirmware:(NSString * _Nonnull)firmwarePath;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_PROTOCOL("_TtP8StarSCAN26StarSCANPeripheralDelegate_")
@protocol StarSCANPeripheralDelegate <NSObject>
@optional
/// 外围设备连接成功并且可读写数据
/// new peripheral has connected, ready for write/read data
/// same as StarSCANCentralDelegate.onPeripheralReady
- (void)onReady:(StarSCANPeripheral * _Nonnull)peripheral;
/// 外围设备断开连接
/// peripheral did disconnected
/// same as StarSCANCentralDelegate.onPeripheralDidDisconnect
- (void)onDidDisconnect:(StarSCANPeripheral * _Nonnull)peripheral;
/// 扫码识别结果
/// scan data
- (void)onScanDataReceived:(StarSCANPeripheral * _Nonnull)peripheral :(NSData * _Nonnull)data;
/// 电量 -1错误/初始状态,0-100电量值
/// battery level, -1 error/init, 0-100 level
- (void)onBatteryLevelRead:(StarSCANPeripheral * _Nonnull)peripheral :(NSInteger)level;
/// 固件版本
/// firmware version
- (void)onFirmwareVersionReceived:(StarSCANPeripheral * _Nonnull)peripheral :(NlsBleFirmwareVersion * _Nonnull)firmware;
/// 外围设备配置数据xml
/// peripheral config xml
- (void)onDeviceConfigReceived:(StarSCANPeripheral * _Nonnull)peripheral :(NSString * _Nonnull)config;
/// 设置设备配置数据异步返回的结果,
...
///   </li>
/// </ul>
- (void)onSetDeviceConfigResponse:(StarSCANPeripheral * _Nonnull)peripheral :(NSInteger)ret;
/// 固件升级状态
/// update firmware state
/// <ul>
///   <li>
...
///   </li>
/// </ul>
- (void)onUpdate:(StarSCANPeripheral * _Nonnull)peripheral :(enum FirmwareUpdateState)state :(NSString * _Nonnull)error :(NSInteger)progress;
@end
